...
export class SeiSwapService extends Service {
  ...
  getAvailableTokens() {
    ...
    return {
      ...
      // Update these addresses for mainnet - these are placeholder addresses
      // You should replace these with actual mainnet token addresses
      seiyan: '0x5f0e07dfee5832faa00c63f2d33a0d79150e8598', // SEIYAN - UPDATE FOR MAINNET
