 ...
 * @category ABI
 */
export declare const ETHERS_STAKING_PRECOMPILE_ABI: InterfaceAbi;
/**
 ...
 */
export declare const getStakingPrecompileEthersV6Contract: (runner: ContractRunner) => Contract;
