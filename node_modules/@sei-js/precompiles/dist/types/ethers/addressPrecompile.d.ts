 ...
 * @category ABI
 */
export declare const ETHERS_ADDRESS_PRECOMPILE_ABI: InterfaceAbi;
/**
 ...
 */
export declare function getAddressPrecompileEthersV6Contract(runner: ContractRunner): Contract;
