 ...
 * @category ABI
 */
export declare const ETHERS_POINTER_PRECOMPILE_ABI: InterfaceAbi;
/**
 ...
 */
export declare const getPointerPrecompileEthersV6Contract: (runner: ContractRunner) => Contract;
