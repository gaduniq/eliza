 ...
 * @category ABI
 */
export declare const ETHERS_POINTERVIEW_PRECOMPILE_ABI: InterfaceAbi;
/**
 ...
 */
export declare const getPointerviewPrecompileEthersV6Contract: (runner: ContractRunner) => Contract;
