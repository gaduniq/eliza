 ...
 * @category ABI
 */
export declare const ETHERS_GOVERNANCE_PRECOMPILE_ABI: InterfaceAbi;
/**
 ...
 */
export declare const getGovernancePrecompileEthersV6Contract: (runner: ContractRunner) => Contract;
