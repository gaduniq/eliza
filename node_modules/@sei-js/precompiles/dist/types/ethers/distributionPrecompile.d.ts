 ...
 * @category ABI
 */
export declare const ETHERS_DISTRIBUTION_PRECOMPILE_ABI: InterfaceAbi;
/**
 ...
 */
export declare const getDistributionPrecompileEthersV6Contract: (runner: ContractRunner) => Contract;
